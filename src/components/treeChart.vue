...
<template>
  <div class="treeCharts">
    ...
    <commonDialog dialogTitle="使用帮助" dialogWidth="600px" :isShowFooterBtn="false" :modal="true" ref="dialog">
      <p>
        ·图例(左上方)：<br />传统色名的层级关系是 越顶层代表的越宏观抽象，越底层代表的色名越微观具体。<br />
        <br />
        ·树图（视觉中心）：<br />最外圈是三级通用色名，对应的二级展示了颜色的等级地位<br />在古代的地位正色-青赤黄白黑 更加尊贵；间色-绿碧红紫流黄
        更加卑贱<br />一级是最宏观的概念色彩，可对应五行关系加以解释。
        <br />
